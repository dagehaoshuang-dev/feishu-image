...
### 教育辅导
- 家长在飞书群发送孩子的作业照片，AI 自动获取并批改
- 老师发送试卷图片，AI 识别题目并生成解析

### 工作协作
- 获取群里分享的设计稿截图，AI 进行 UI 审查或提取文案
- 抓取群内的白板/会议纪要照片，AI 识别并整理为结构化文本
- 提取产品 bug 截图，AI 分析问题并生成工单描述

### 信息提取
- 获取群里分享的名片/证件照片，AI 识别关键信息
- 抓取数据报表截图，AI 提取数据并生成分析报告
- 读取群内的文档/合同照片，AI 进行 OCR 识别和摘要

### 生活场景
- 获取群里的菜谱图片，AI 识别食材和步骤
- 抓取旅行中分享的地图/路线截图，AI 提供导航建议
- 读取群内的购物清单或收据照片，AI 整理并记账
